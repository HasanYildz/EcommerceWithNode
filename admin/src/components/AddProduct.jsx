  ...
  return (
    ...
    >
      ...
      <div className="mb-3 flex items-center gap-x-4">
        ...
        ring-1 ring-slate-900/20 rounded-sm outline-none'>
      ...
      <div>
        ...
        <input onChange={imageHandler} type="file" name="image" id="file-input" hidden className="bg-primary max-w-80 w-full py-4 px-4"/>
      </div>
