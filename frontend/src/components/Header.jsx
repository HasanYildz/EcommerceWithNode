  ...
  return (
    <header className='fixed top-0 left-0 w-full bg-white ring-1 ring-slate-900/5 z-10'>
      <div className='px-4 flex justify-between items-center py-3 max-xs:px-2'>
        ...
        {/* Navbar Mobile */}
        <Navbar containerStyles={`${menuOpened ? 'flex items-start flex-col gap-y-12 fixed top-20 right-8 p-12 bg-white rounded-3xl shadow-md w-64 md:w-96 ring-1 ring-slate-900/5 transition-all duration-300' : 'hidden'}`} />
